...
void example0705()
{
    ...
    intSWorkArray1(wa, sizeof(wa)/sizeof(SWork));
    // intSWorkArray2 ==> 1006,孙七,750.200012
    intSWorkArray2(wa, sizeof(wa)/sizeof(SWork));
    // outSWorkArray ==> 1009,赵六,310.540009
    outSWorkArray(wa, sizeof(wa)/sizeof(SWork));

    // intSWorkArray3 ==> 1006,钱八,910.260010
    intSWorkArray3(wa, sizeof(wa)/sizeof(SWork));
